 ...
 */
@Entity
@Table(name="bucalcenter.administrador")
public class Administrador implements Serializable {
	...
	@Column(name="OCUPACION_ADMINISTRADOR")
	private String ocupacionAdministrador;
	...
	public String getOcupacionAdministrador() {
		return this.ocupacionAdministrador;
	}

	public void setOcupacionAdministrador(String ocupacionAdministrador) {
		this.ocupacionAdministrador = ocupacionAdministrador;
	}
